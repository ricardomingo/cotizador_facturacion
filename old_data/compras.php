<form name="form1" method="post" action="">
  <div align="center">
    <table width="200" border="1">
      <tr>
        <td bgcolor="#CCFF33">Numero de Factura de Compra</td>
        <td bgcolor="#CCFF33"><label for="txt_num_factura_compra"></label><input name="txt_num_factura_compra" type="text" id="txt_num_factura_compra" size="5" maxlength="5"></td>
      </tr>
      <tr>
...
mysql_db_query("fix_tech_support","insert into compras('num_factura_compra','clave_proveedor','fecha','total') values ('txt_num_factura_compra','txt_clave_proveedor','txt_fecha','total')");	  
